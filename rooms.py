...
r.description[(('Rusty Key',), ())] = "The lock has shown itself. For some reason it's in the bottom left corner."
r.description[((), ())] = "The door has opened you can now move 'south'."
rooms[(0,0,0)] = r
#Room 1
r = Room()
